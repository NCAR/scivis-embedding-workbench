...
Layered so each module has one job:
    ...
    data.py       LanceDB: experiments, patch vectors, source images
    ...
    experiment.py PatchExperiment / PatchSample / DisplayOptions facades
...
from helpers.experiment import DisplayOptions, PatchExperiment, PatchSample

__all__ = ["DisplayOptions", "PatchExperiment", "PatchSample"]
